...
public class RelationalDataAccessApplication {
	...
	public void run(String... strings) throws Exception {
		...
		// Split up th array of whole names into a an array of first/last names
		...
		jdbcTemplate.query("SELECT id, first_name, last_name FROM customers WHERE first_name = ?", 
		  (rs, rowNum) -> new Customer(rs.getLong("id"), rs.getString("first_name"), rs_getString("last_name")), "Josh")
